...
import type { I1nProjectConfig, Format } from "./types.js";
...
export function generateI1nInstructions(config: I1nProjectConfig): string {
  const structure =
  ...
  return [
    ...
    "- After adding or modifying translation keys, remind the user to run `i1n push` to sync changes.",
...
export function writeAIConfigs(
  ...
  const content = generateI1nInstructions(config);
